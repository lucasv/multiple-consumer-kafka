...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> groupOneKafkaListenerContainerFactory() {
        final ConcurrentKafkaListenerContainerFactory factory = kafkaListenerContainerFactory("group1");
        factory.setRecordFilterStrategy(record -> record.value().toString().contains("1"));
        return factory;
    }
